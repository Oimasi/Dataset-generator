...
ОБЯЗАТЕЛЬНО соблюдай типы данных:
- integer: целые числа без кавычек (1500, 42, 0)
- number: числа с десятичными без кавычек (3.14, 2.5)
- string: строки в кавычках ("текст", "2023-12-01")
...
⚠️ КРИТИЧЕСКИ ВАЖНО:
- Используй ТОЧНО ТЕ ЖЕ ключи JSON: {required_keys}
- ЗАПРЕЩЕНО изменять или заменять имена ключей
- ЗАПРЕЩЕНО добавлять новые ключи
- ЗАПРЕЩЕНО удалять существующие ключи
...
- ОБЯЗАТЕЛЬНО соблюдай типы данных:
  * integer - только целые числа (например: 1500, 42, 0)
  * number - числа с десятичными (например: 3.14, 2.5)
  * string - текстовые строки (например: "продукты", "2023-12-01")
